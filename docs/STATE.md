...
- **Phase:** 1 — The list
- **Current WP:** WP1.1 (done) → next is WP1.2
- **Next action:** WP1.2 — harvest kerala.gov.in's department/organisation directories into `registry/candidates/kerala-gov-in.yaml`. Read docs/IMPLEMENTATION.md's WP1.2 section first.
