...
- **Phase:** 1 — The list
- **Current WP:** WP1.2 (done) → next is WP1.3
- **Next action:** WP1.3 — harvest goidirectory.gov.in's Kerala section into `registry/candidates/goidirectory.yaml`; run `merge-candidates.ts` and record the overlap with WP1.2 (expect 40-70%).
